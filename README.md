...
---
#### Шаг 6: Настройка русского языка
1. Откройте файл `config/web.php` в вашем проекте.
2. Добавьте свойство `language` в массив $config со значением ru-RU:
   ```php
    $config = [
    'language' => 'ru-RU',
    'id' => 'basic',
   ...
   ```
3. Сохраните файл.
<img width="612" height="293" alt="image" src="https://github.com/user-attachments/assets/904c3d22-2dbc-4c8b-83da-3df3c202c2de" />
